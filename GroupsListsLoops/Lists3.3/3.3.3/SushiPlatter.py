...
def drawThreeSushi(colorIndex1, colorIndex2, colorIndex3):
    # We've drawn 3 sushi for you. However, the colors for the filling are
    # incorrect. Use the app.fillings list and the colorIndex parameters to get
    # the appropriate colors for the three calls to drawSushi.
    ### Fix Your Code Here ###
