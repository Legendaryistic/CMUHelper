...
def onKeyPress(key):
    ...
    sumResult.value = str(int(numRedApples) + int(numGreenApples))
    ...
    ### Fix Your Code Here ###
    statement.value = numRedApples + ' red apples and ' + numGreenApples + ' green apples makes ' + str(int(numRedApples) + int(numGreenApples)) + ' apples total!'
