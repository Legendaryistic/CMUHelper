...
sun = Star(350, 200, 50, 500, fill=gradient('papayaWhip', 'moccasin'), roundness=80)
def drawBuilding(mouseX, mouseY):
    Rect(mouseX, mouseY + 10, 60, 400 - mouseY, align='top',
         fill=gradient(rgb(150, 95, 90), rgb(195, 110, 115), start='left')).toBack()
...
def onMousePress(mouseX, mouseY):
    building = drawBuilding(mouseX,mouseY)
