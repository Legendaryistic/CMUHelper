...
### Fix Your Code Here ###
wormDown = Line(25, 322, 75, 322, lineWidth =6, fill = 'mediumVioletRed')
wormUp = Star(wormDown.centerX+5, wormDown.centerY+10, 20, 6, borderWidth = 6, roundness = 80, fill = None, border = 'mediumVioletRed', visible = False)
