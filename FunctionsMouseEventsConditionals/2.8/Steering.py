...
grip1 = Polygon(38, 355, 43, 330, 90, 345, 88, 360, 88, 380, 90, 395, 43, 410, 38, 385,
        fill=rgb(65, 73, 84))
grip2 = Polygon(362, 355, 357, 330, 310, 345, 312, 360, 312, 380, 310, 395, 357, 410,
...
def onMousePress(mouseX, mouseY):
    ...
    if steeringWheel.contains(mouseX,mouseY):
        if grip1.contains(leftHand.centerX, leftHand.centerY):
            message.value = 'Good!'
        else:
            message.value = 'Close!'
    else:
