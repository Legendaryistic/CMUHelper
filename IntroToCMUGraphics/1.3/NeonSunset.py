...
### Place Your Code Here ###
Polygon(70,255,130,355,10,355, fill = gradient('blueViolet', 'magenta', start = 'bottom-left'))
Polygon(345,260,400,355,300,355, fill = gradient('darkOrchid', 'slateBlue', start = 'top-left'))
Polygon(310,230,235,355,385,355, fill = gradient('darkViolet', 'magenta', start = 'bottom-right'))
