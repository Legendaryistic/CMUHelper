...
Polygon(120,75,145,85,180,150,125,100, fill='orange')
Polygon(70,100,125,115,160,165,100,140, fill='orange')
...
### Place Your Code Here ###
Polygon(280,210,320,225,285,240,240,230, fill='white')
Polygon(290,245,320,235,325,250,305,265, fill='white')
Polygon(275,245,295,270,255,270,220,250, fill='white')
